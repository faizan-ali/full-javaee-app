                    ...
                    <div class="container-fluid platform-nav-container">
                        <div class="row platform-nav">
                            ...
                            <div class="hidden-xs">
                                ...
                                <div class="col-md-2 text-center platform-nav-button subhead-1-2 platform-nav-button-border pull-right">Employer Logs</div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="row row-centered" style="margin-top: 25px; margin-bottom: 65px;">
                            <div class="col-md-10 col-centered">
                                <table class="table table-hover" id="table">
                                    ...
                                    <tbody>
                                        <c:forEach var="elt" items="${clientList}">
                                            <tr class="body-bold-1-1">
                                                <td>
                                                    <a href="../AdministratorViewClientStatistics?clientID=${elt.clientID}">${elt.firstName} ${elt.lastName}</a>
                                                </td>
                                                <td>${elt.company.name}</td>
                                                <td>${elt.email}</td>
