                        ...
                        <div class="container candidate-profile-marginator">
                            <div class="row row-centered candidate-profile-container">
                                ...
                                <div class="col-md-6 col-centered col-xs-12 box-shadow" id="profile-card-edit">
                                    ...
                                    <div class="col-md-3 candidate-photo-resume-box-edit remove-horizontal-padding text-center">
                                        ...
                                        <div class="body-bold-1-1 small" style="color: green;">${adminSuccess}</div>
                                    ...
                                    <div class="col-md-8 candidate-summary-box-edit remove-horizontal-padding">
                                        ...
                                        <div class="col-md-12" id="schools">
                                            ...
                                            <input type="hidden" name="school" value="" form="updateForm">
                            ...
                            <div class="row row-centered">
                                ...
                                <div class="col-md-6 col-centered col-xs-12 candidate-detail-container" id="candidate-detail-edit">
                                    ...
                                    <form action="../AdministratorCreateCandidateServlet" id="updateForm" name="candidate.orm" onsubmit="return removeLocalItems()">
                                        <div class="row">
                                        ...
                                        <div class="row" style="border-bottom: none;">
                                            <div class="col-xs-12">
                                                <div class="body-bold-1-1">13. WorkAmerica authorization*</div>
                                                <div class="radio">
                                                    <label class="body-1-1">
                                                        <input type="radio" name="authorized" value="Yes" />Yes- Allow employers to find my profile when searching for candidates
                                                    </label>
                                                </div>
                                                <div class="radio">
                                                    <label class="body-1-1">
                                                        <input type="radio" name="authorized" value="No" />No- Employers will not be be able to find my profile when searching for candidates
                                                    </label>
                                                </div>
                                                <div class="detail-1-1">Click Yes to authorize WorkAmerica to share your complete profile with our employers.</div>
                                            </div>
                                        </div>
