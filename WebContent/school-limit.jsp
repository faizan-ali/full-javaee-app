                    ...
                    <div class="container" style="height: 380px;">
                        <div class="row row-centered" style="margin-top: 150px; margin-bottom: 10px;">
                            <div class="col-md-8 col-centered">
                                <h2 class="heading-1-1 text-center">Candidate outside school restrictions</h2>
                                <div class="body-1-1 text-center" style="font-size: 18px !important; margin-top: 20px;">You have attempted to view a candidate outside your assigned school of : ${user.schoolAccount.school.name}. If you believe this is an error or for more information please contact us at info@workamerica.co</div>
