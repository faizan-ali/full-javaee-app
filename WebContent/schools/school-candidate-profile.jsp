...
Scrolling is disabled for this page. -->
                        ...
                        <div class="hidden-xs">
                            <div class="col-md-3 platform-nav-back">
                                ...
                                <div class="subhead-1-3 col-md-9">
                                    <a href="school-candidates.jsp">Back To Candidate List</a>
                                </div>
                            </div>
                    ...
                    <div class="container candidate-profile-marginator">
                                ...
                                <div class="col-md-3 candidate-photo-resume-box-edit remove-horizontal-padding text-center">
                                    ...
                                    <c:choose>
                                        <c:when test="${empty candidate.photo}">
                                            <form action="../SchoolPictureUploadServlet" enctype="multipart/form-data" method="post" id="picture-upload">
                                        ...
                                        <c:otherwise>
                                            ...
                                            <form action="../SchoolPictureUploadServlet" enctype="multipart/form-data" method="post">
                                                <div class="image-upload">
                                                    <label for="file-input">
                                                        <c:choose>
                                                            <c:when test="${empty candidate.photo}">
                                    ...
                                    <form action="../SchoolResumeUploadServlet" method="post" enctype="multipart/form-data" id="resume-upload">
                                        ...
                                        <input type="hidden" name="source" value="school">
                                        <input type="file" name="resume" style="width: 100%" onchange="submit();" id="resumeSubmit">
                                        </span>
                                    </form>
                        ...
                        <div class="row row-centered">
                            ...
                            <div class="col-md-6 col-centered col-xs-12 candidate-detail-container" id="candidate-detail-edit">
                                ...
                                <form action="../SchoolCandidateUpdateServlet" id="updateForm" name="candidate.orm" onsubmit="return removeLocalItems()">
                                    <div class="row">
                ...
                <script>
                    function submitResume(id) {
                        $('#resume-upload').append('<input type="hidden" name="source" value="school"/>');
