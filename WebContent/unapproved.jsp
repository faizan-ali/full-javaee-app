                    ...
                    <div class="container" style="height: 380px;">
                        <div class="row row-centered" style="margin-top: 150px; margin-bottom: 10px;">
                            <div class="col-md-8 col-centered">
                                <h2 class="heading-1-1 text-center">Your account is pending approval</h2>
                                <div class="body-1-1 text-center" style="font-size: 18px !important; margin-top: 20px;">Your account is currently pending approval by the WorkAmerica team. This is a security measure to ensure the privacy of our candidates and their information. If you believe this is an error please contact us at info@workamerica.co</div>
                                <div class="body-1-1 text-center" style="font-size: 18px !important; margin-top: 20px;">You will now be automatically redirected back to your search results</div>
                            </div>
                        </div>
                    </div>
                </div>
