    ...
    <%@ page language="java" contentType="text/html; charset=ISO-8859-1"
        ...
        <%@ taglib prefix="c" uri="http://java.sun.com/jsp/jstl/core"%>
            ...
            <head>
                ...
                <meta http-equiv="refresh" content="10;url=landing.jsp" />
                    ...
                    <div class="container" style="height: 380px;">
                        <div class="row row-centered" style="margin-top: 150px; margin-bottom: 10px;">
                            <div class="col-md-8 col-centered">
                                <h2 class="heading-1-1 text-center">Profile View Limit Reached</h2>
                                <div class="body-1-1 text-center" style="font-size: 18px !important; margin-top: 20px;">You have reached your monthly limit for candidate profile views. For more information, or to increase this limit, please contact us at info@workamerica.co</div>
                                <div class="body-1-1 text-center" style="font-size: 18px !important; margin-top: 20px;">You will now be automatically redirected to your home page</div>
                            </div>
                        </div>
                    </div>
                </div>
